...
function preload() {
  ...
  sadzombie = loadAnimation("./assets/sad_zombie.png");
...
function draw() {
  ...
  for (var stone of stones) {
    stone.show();
    //guarda a posição da pedra
    var pos = stone.body.position;
    //programe para calcular a distância entre o zumbi e a pedra
    //com a função dist()
    

    //programe para que se a distância for menor que 50
    //a animação do zumbi mude para triste e ele fique com 0 de velocidade
